...
def write_app_log (message ,exc =None ,app_instance =None ,app_data =None ,app_id =None ,source ="App"):
...
def print_and_log (message ,exc =None ,app_instance =None ,app_data =None ,app_id =None ,source ="App"):
    resolved_app_id =resolve_app_id (
    app_instance =app_instance ,
    app_data =app_data ,
    app_id =app_id ,
...
def safe_app_call (func ,default =None ,action_name ="unknown",app_instance =None ,app_data =None ,app_id =None ,source ="App"):
    try :
        return func ()
