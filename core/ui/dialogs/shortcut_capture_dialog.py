...
class ShortcutCaptureDialog (QDialog ):
    def __init__ (self ,current_shortcut ="",parent =None ):
        ...
        try :
            ...
            dock =getattr (parent_widget ,"dock_window",None )if parent_widget is not None else None 
            if dock is not None and loaded is not None and hasattr (dock ,"get_app_shortcut"):
                try :
