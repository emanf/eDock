...
class InputDialog(QDialog):
    ...
    def get_theme_colors(self):
        ...
        return {
            ...
            "cancel_background": uic(
                cancel_button.get(Theme.Components.Button.BACKGROUND_COLOR)
            ),
            "cancel_hover": uic(cancel_button.get(Theme.Components.Button.HOVER_COLOR)),
            "cancel_pressed": uic(
                cancel_button.get(Theme.Components.Button.PRESSED_COLOR)
            ),
            "cancel_border": uic(
                cancel_button.get(Theme.Components.Button.BORDER_COLOR)
            ),
            "cancel_text": uic(cancel_button.get(Theme.Components.Button.TEXT_COLOR)),
            "cancel_border_width": cancel_button.get(
                Theme.Components.Button.BORDER_WIDTH
            ),
            "cancel_border_radius": cancel_button.get(
            ...
            "input_background": uic(
                input_theme.get(Theme.Components.Input.BACKGROUND_COLOR)
            ),
            ...
            "input_border_radius": input_theme.get(
                Theme.Components.Input.BORDER_RADIUS
            ),
            ...
            "input_selection_background": uic(
                confirm_button.get(Theme.Components.Button.BACKGROUND_COLOR)
            ),
            "input_selection_text": uic(
                confirm_button.get(Theme.Components.Button.TEXT_COLOR)
            ),
        }
