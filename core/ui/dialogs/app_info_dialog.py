...
class AppInfoDialog (QDialog ):
    ...
    def build_rows (self ):
        ...
        for key ,value in self .app_data .items ():
            if key not in ("title","description","author","author_email","author_website","version","last_modified","id","icon")and value :
    ...
    def find_app_json_path (self ):
        ...
        expected_title =self .find_expected_value ("title")or self .find_expected_value ("name")
