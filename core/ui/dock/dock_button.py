...
class DockButton(QPushButton):
    ...
    def open_shortcut_dialog(self):
        ...
        if self.dock_window and hasattr(self.dock_window, "refresh_shortcuts"):
            self.dock_window.refresh_shortcuts()
        elif self.dock_window and hasattr(self.dock_window, "register_all_shortcuts"):
            self.dock_window.register_all_shortcuts()
