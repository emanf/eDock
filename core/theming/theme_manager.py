...
from core.paths import ROOT_DIR, USER_CONFIG_PATH, get_core_themes_dir, get_user_themes_dir
...
class ThemePathResolver:
    ...
    def get_theme_path(cls, theme_id, source):
        ...
        if source == cls.SOURCE_LOCAL:
            ...
            return None if local_dir is None else local_dir / f"{theme_id}{THEME_FILE_EXTENSION}"
...
class ThemeRegistry:
    ...
    def list_builtin_themes(cls):
        return cls._list_theme_names_from_dir(ThemePathResolver.get_builtin_themes_dir())
...
class Theme:
    ...
    def _resolve_theme_from_path(cls, path_value, _visited=None, _base_dir=None):
        ...
        theme_data = cls.ensure_theme_meta(
            ...
            theme_type=theme_data.get("meta", {}).get("type") or ThemePathResolver.SOURCE_FILE,
        )
        ...
        if base_id:
            if cls._looks_like_theme_path(base_id):
                ...
                if cls.normalize_theme_id(base_id) != cls.normalize_theme_id(theme_data.get("meta", {}).get("id")):
    ...
    def resolve_theme(cls, theme_id, _visited=None):
        ...
        if theme_data is not None:
            theme_data = cls.ensure_theme_meta(theme_data, theme_id=theme_id, theme_type=theme_source)
            base_id = cls._extract_base_id(theme_data)

            if base_id:
                if cls._looks_like_theme_path(base_id):
                    base_theme = cls._resolve_theme_from_path(base_id, _visited=_visited)
                else:
                    base_theme = cls.resolve_theme(base_id, _visited) if base_id != theme_id else {}
                merged = cls.deep_merge_dict(base_theme, theme_data)
                return cls.ensure_theme_defaults(merged)
    ...
    def save_user_theme(cls, theme_id, theme_data):
        ...
        theme_data = cls.ensure_theme_meta(theme_data, theme_id=theme_id, theme_type="user")
        path = cls.get_user_theme_path(theme_id)
    ...
    @classmethod
    def create_user_theme(cls, theme_id, display_name=None, base_theme_id=DEFAULT_THEME_ID):
        theme_id = cls._safe_theme_id(theme_id)
    ...
    @classmethod
    def get_component_variant(cls, component_name, variant_name="normal", theme_data=None, default=None):
    ...
    def get_button_color(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        ...
        return button.get(cls.Components.Button.COLOR) or button.get(cls.Components.Button.TEXT_COLOR)

    @classmethod
    def get_button_background_color(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.BACKGROUND_COLOR)

    @classmethod
    def get_button_hover_color(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.HOVER_COLOR)

    @classmethod
    def get_button_pressed_color(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.PRESSED_COLOR)

    @classmethod
    def get_button_border_color(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.BORDER_COLOR)

    @classmethod
    def get_button_border_width(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.BORDER_WIDTH)

    @classmethod
    def get_button_radius(cls, variant_name=BUTTON_NORMAL, theme_data=None):
        return cls.get_button(variant_name, theme_data=theme_data).get(cls.Components.Button.BORDER_RADIUS)

    @classmethod
    def get_icon_color(cls, variant_name=ICON_NORMAL, theme_data=None):
        return cls.get_icon(variant_name, theme_data=theme_data).get(cls.Components.Icon.COLOR)

    @classmethod
    def get_icon_size(cls, variant_name=ICON_NORMAL, theme_data=None):
        return cls.get_icon(variant_name, theme_data=theme_data).get(cls.Components.Icon.SIZE)

    @classmethod
    def get_icon_padding(cls, variant_name=ICON_NORMAL, theme_data=None):
        return cls.get_icon(variant_name, theme_data=theme_data).get(cls.Components.Icon.PADDING)

    @classmethod
    def get_text_color(cls, variant_name=TEXT_NORMAL, theme_data=None):
        return cls.get_text(variant_name, theme_data=theme_data).get(cls.Components.Text.COLOR)

    @classmethod
    def get_dock_background_color(cls, theme_data=None):
        return cls.get_dock(theme_data=theme_data).get(cls.Components.Dock.BACKGROUND_COLOR)
    ...
    def get_dock_radius(cls, theme_data=None):
        return cls.get_dock(theme_data=theme_data).get(cls.Components.Dock.BORDER_RADIUS)

    @classmethod
    def get_dialog_background_color(cls, theme_data=None):
        return cls.get_dialog(theme_data=theme_data).get(cls.Components.Dialog.BACKGROUND_COLOR)

    @classmethod
    def get_dialog_border_color(cls, theme_data=None):
        return cls.get_dialog(theme_data=theme_data).get(cls.Components.Dialog.BORDER_COLOR)

    @classmethod
    def get_dialog_border_width(cls, theme_data=None):
        return cls.get_dialog(theme_data=theme_data).get(cls.Components.Dialog.BORDER_WIDTH)

    @classmethod
    def get_dialog_radius(cls, theme_data=None):
        return cls.get_dialog(theme_data=theme_data).get(cls.Components.Dialog.BORDER_RADIUS)

    @classmethod
    def get_dialog_text_color(cls, theme_data=None):
        return cls.get_dialog(theme_data=theme_data).get(cls.Components.Dialog.TEXT_COLOR)

    @classmethod
    def get_tooltip_background_color(cls, theme_data=None):
        return cls.get_tooltip(theme_data=theme_data).get(cls.Components.Dialog.BACKGROUND_COLOR)

    @classmethod
    def get_tooltip_border_color(cls, theme_data=None):
        return cls.get_tooltip(theme_data=theme_data).get(cls.Components.Dialog.BORDER_COLOR)

    @classmethod
    def get_tooltip_border_width(cls, theme_data=None):
        return cls.get_tooltip(theme_data=theme_data).get(cls.Components.Dialog.BORDER_WIDTH)

    @classmethod
    def get_tooltip_radius(cls, theme_data=None):
        return cls.get_tooltip(theme_data=theme_data).get(cls.Components.Dialog.BORDER_RADIUS)

    @classmethod
    def get_tooltip_text_color(cls, theme_data=None):
        return cls.get_tooltip(theme_data=theme_data).get(cls.Components.Dialog.TEXT_COLOR)
